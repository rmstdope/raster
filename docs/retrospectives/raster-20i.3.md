...
**Cost.** One failed worktree-preparation attempt and a retry, about two minutes.
...
**Seen before.** raster-tf5.2 — same configured install command and setup failure.
