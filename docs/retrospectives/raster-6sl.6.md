...
**Cost.** One failed worktree-preparation attempt; the already-created worktree was usable after
...
**Seen before.** raster-tf5.2, raster-tf5.3, and raster-20i.3 — same command and setup failure.
