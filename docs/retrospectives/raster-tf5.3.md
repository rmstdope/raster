...
**Cost.** One failed worktree-preparation attempt and a subsequent dependency build, about five minutes.
...
**Seen before.** raster-tf5.2 — same command and failure.
