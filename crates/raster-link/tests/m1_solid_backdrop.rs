...
fn uses_the_fixed_bank_reset_and_interrupt_vectors() {
    ...
    assert_eq!(vector(&rom, 0xfffa), 0xe09f);
    assert_eq!(vector(&rom, 0xfffc), 0xe000);
    assert_eq!(vector(&rom, 0xfffe), 0xe09f);
    assert_eq!(fixed_bank(&rom)[0x9f], 0x40);
}
...
fn initializes_before_writing_the_blue_universal_backdrop() {
    ...
    let mmc3 = [
        ...
        0xa9, 0x00, 0x8d, 0x00, 0x80, 0xa9, 0x00, 0x8d, 0x01, 0x80, 0xa9, 0x01, 0x8d, 0x00, 0x80,
        0xa9, 0x02, 0x8d, 0x01, 0x80, 0xa9, 0x02, 0x8d, 0x00, 0x80, 0xa9, 0x04, 0x8d, 0x01, 0x80,
        0xa9, 0x03, 0x8d, 0x00, 0x80, 0xa9, 0x05, 0x8d, 0x01, 0x80, 0xa9, 0x04, 0x8d, 0x00, 0x80,
        0xa9, 0x06, 0x8d, 0x01, 0x80, 0xa9, 0x05, 0x8d, 0x00, 0x80, 0xa9, 0x07, 0x8d, 0x01, 0x80,
    ...
    let latch_reset_and_entry = [0x2c, 0x02, 0x20, 0x4c, 0x83, 0xe0];
    let palette_write = [
...
fn hand_built_mmc3_rom_is_byte_identical_after_assembler_migration() {
    ...
    // The 131-byte shared runtime, then M1's own body: the palette write, the two
    // writes that leave palette space, a halt loop that jumps to itself at $E09C,
    // and the interrupt stub the vectors point at, at $E09F.
    let reset_program = [
        ,
    ];
    assert_eq!(reset_program.len(), 160);
    ...
    expected[INES_HEADER_SIZE + MMC3_PRG_ROM_SIZE - 6..]
        .copy_from_slice(&[0x9f, 0xe0, 0x00, 0xe0, 0x9f, 0xe0]);
