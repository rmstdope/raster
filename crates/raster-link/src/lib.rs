...
pub fn emit_mmc3_ines(
    ...
    image[INES_HEADER_SIZE + MMC3_PRG_ROM_SIZE - 6..].copy_from_slice(&[
        vectors.nmi.to_le_bytes()[0],
        vectors.nmi.to_le_bytes()[1],
        vectors.reset.to_le_bytes()[0],
        vectors.reset.to_le_bytes()[1],
        vectors.irq.to_le_bytes()[0],
        vectors.irq.to_le_bytes()[1],
    ]);
